// Example program #1 from Chapter 25
// File Chapter25ex1.c

/* declares & initializes an array of character pointers. */
...
main()
{
    ...
    char * movies[9] = {"Amour", "Argo", "Beasts of the Southern Wild", "Django Unchained", "Les Miserables", "Life of Pi", "Lincoln",
